...
THREE.OrbitControls.prototype = {
    ...
    update: function() {
        ...
        // Allow full 360-degree vertical rotation by removing phi restrictions
    ...
    handleMouseMoveRotate: function(event) {
        ...
        this.rotateDelta.subVectors(this.rotateEnd, this.rotateStart).multiplyScalar(0.005 * this.rotateSpeed); // Reduced from 0.01 to 0.005
        
        const element = this.domElement;
        
        // Increased sensitivity by using clientWidth for horizontal and reducing divisor
        this.sphericalDelta.theta -= 4 * Math.PI * this.rotateDelta.x / element.clientWidth;  // More sensitive horizontal rotation
        this.sphericalDelta.phi -= 4 * Math.PI * this.rotateDelta.y / element.clientHeight;   // More sensitive vertical rotation
